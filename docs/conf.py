# -*- coding: utf-8 -*-
#
# pytest-dragons documentation build configuration file, created by
...
project = 'pytest-dragons'
copyright = '2015, Association of Universities for Research in Astronomy'
author = 'NOIRLab / GEMINI - Science User Support Department'
...
intersphinx_mapping = {
    'astrodata': ('https://astrodata-user-manual.readthedocs.io/en/stable/', None),
    'astropy': ('https://docs.astropy.org/en/stable/', None),
    'gemini_instruments': ('https://dragons-recipe-system-programmers-manual.readthedocs.io/en/stable/', None),
    'geminidr': ('https://dragons-recipe-system-programmers-manual.readthedocs.io/en/stable/', None),
...
htmlhelp_basename = 'pytest-dragons-doc'
...
latex_documents = [
  ('index', 'pytest-dragons-doc.tex', 'pytest-dragons', 'Bruno C. Quint', 'manual'),
]
...
man_pages = [
    ('index', 'pytest-dragons-manual', 'pytest-dragons Documentation',
     ['Bruno C. Quint'], 1)
]
...
texinfo_documents = [
  (master_doc, 'pytest-dragons', 'pytest-dragons Documentation',
   ['Bruno C. Quint'], 'pytest-dragons', "PyTest plug-ins used in DRAGONS' tests",
   'Miscellaneous'),
]
