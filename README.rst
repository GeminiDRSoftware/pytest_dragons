...
You can install "pytest-dragons" via `pip`_ from `PyPI`_::

    $ pip install pytest-dragons
...
Distributed under the terms of the `MIT`_ license, "pytest-dragons" is free and open source software
...
.. _`file an issue`: https://github.com/b1quint/pytest-dragons/issues
